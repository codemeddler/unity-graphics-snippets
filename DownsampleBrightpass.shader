Shader "Post Process/Down Sample Bright Pass"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                v2f o;
                o.vertex = v.vertex;
                half2 half_texel_size = _TexelSize.xy * 0.5h;

                o.uv_0 = v.uv;
                o.uv_1 = v.uv - half_texel_size;
                o.uv_2 = v.uv + half_texel_size * half2(1.0h, -1.0h);
                o.uv_3 = v.uv + half_texel_size * half2(-1.0h, 1.0h);
                o.uv_4 = v.uv + half_texel_size;
